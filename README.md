<div class="Box-sc-g0xbh4-0 bJMeLZ js-snippet-clipboard-copy-unpositioned" data-hpc="true"><article class="markdown-body entry-content container-lg" itemprop="text"><p align="center" dir="auto">
  <a target="_blank" rel="noopener noreferrer" href="https://github.com/msaad1999/KLiK-SocialMediaWebsite/blob/master/_git%20assets/cover.png"><img src="https://github.com/msaad1999/KLiK-SocialMediaWebsite/raw/master/_git%20assets/cover.png" width="600" align="center" style="max-width: 100%;"></a>
</p>
<blockquote>
...
<li><a href="#future-improvements"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">未来的改进</font></font></a></li>
...
<p align="center" dir="auto">
  <a target="_blank" rel="noopener noreferrer" href="https://github.com/msaad1999/KLiK-SocialMediaWebsite/blob/master/_git%20assets/dashboard.png"><img src="https://github.com/msaad1999/KLiK-SocialMediaWebsite/raw/master/_git%20assets/dashboard.png" width="500" align="center" style="max-width: 100%;"></a>
</p>
...
<p align="center" dir="auto">
  <a target="_blank" rel="noopener noreferrer" href="https://github.com/msaad1999/KLiK-SocialMediaWebsite/blob/master/_git%20assets/management.png"><img src="https://github.com/msaad1999/KLiK-SocialMediaWebsite/raw/master/_git%20assets/management.png" width="600" align="center" style="max-width: 100%;"></a>
</p>
<ul dir="auto">
<li>
...
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">在传递事件日期时自动标记为完成</font></font></li>
</ul>
</li>
<li>
...
<p dir="auto">
  <a target="_blank" rel="noopener noreferrer" href="https://github.com/msaad1999/KLiK-SocialMediaWebsite/blob/master/_git%20assets/login.png"><img src="https://github.com/msaad1999/KLiK-SocialMediaWebsite/raw/master/_git%20assets/login.png" width="400" align="right" style="max-width: 100%;"></a>
</p>
...
<td><code>event-page.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">, </font></font><code>events.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">,</font></font><code>create-event.php</code></td>
<td><code>create-event.inc.php</code></td>
</tr>
<tr>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">投票系统</font></font></td>
<td><code>poll.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">, </font></font><code>polls.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">,</font></font><code>poll-voters.php</code></td>
<td><code>create-poll.inc.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">, </font></font><code>delete-poll.inc.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">, </font></font><code>poll.class.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">,</font></font><code>post-vote.inc.php</code></td>
</tr>
<tr>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">聊天室</font></font></td>
<td><code>message.php</code></td>
<td><code>post_message_ajax.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">, </font></font><code>get_message_ajax.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">,</font></font><code>script.js</code></td>
</tr>
<tr>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">注册登录</font></font></td>
<td><code>signup.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">,</font></font><code>login.php</code></td>
<td><code>signup.inc.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">, </font></font><code>login.inc.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">,</font></font><code>logout.inc.php</code></td>
</tr>
<tr>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">型材系统</font></font></td>
<td><code>profile.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">,</font></font><code>edit-profile.php</code></td>
<td><code>profileUpdate.inc.php</code></td>
</tr>
<tr>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">重设密码</font></font></td>
<td><code>reset-pwd.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">,</font></font><code>create-new-pwd.php</code></td>
<td><code>reset-request.inc.php</code></td>
</tr>
<tr>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">图片上传</font></font></td>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">不适用</font></font></td>
<td><code>upload.inc.php</code></td>
</tr>
<tr>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">创作者展示</font></font></td>
<td><code>team.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">, </font></font><code>KLiK_anas-imran.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">, </font></font><code>KLiK_anas-kamal.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">, </font></font><code>KLiK_saad.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">,</font></font><code>KLiK_ubaid.php</code></td>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">不适用</font></font></td>
</tr>
<tr>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">寻找用户</font></font></td>
<td><code>users-view.php</code></td>
<td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">不适用</font></font></td>
</tr>
</tbody>
</table>
<blockquote>
<p dir="auto"><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">注意：</font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> GUI 文件位于</font></font><code>root directory</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">和文件夹</font></font><code>backend files</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">中</font></font><code>includes</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">。</font><font style="vertical-align: inherit;">同样，所有 CSS 和 JS 文件都存在于其透视目录</font></font><code>css</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">和</font></font><code>js</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">目录中。</font><font style="vertical-align: inherit;">只有 Creator 文件有</font></font><code>_KLiK Creators folder</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">自己的 css 文件。</font><font style="vertical-align: inherit;">主要的 HTML 结构文件是</font></font><code>HTML-head.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">和</font></font><code>HTML-footer.php</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">，它们也位于包含文件夹中</font></font></p>
</blockquote>
<div class="markdown-heading" dir="auto"><h2 tabindex="-1" class="heading-element" dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">未来的改进</font></font></h2><a id="user-content-future-improvements" class="anchor" aria-label="永久链接：未来的改进" href="#future-improvements"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a></div>
<ul dir="auto">
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">优化（聊天室等组件）</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">集成先进的框架，如</font></font><code>Laravel</code></li>
<li><font style="vertical-align: inherit;"></font><code>Vue.js</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">聊天室的</font><font style="vertical-align: inherit;">实现。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">持续的错误修复和改进</font></font></li>
</ul>
<blockquote>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">如果您喜欢我的工作，请通过为存储库加注星标来表示支持！</font><font style="vertical-align: inherit;">这对我来说意义重大，也是我所要求的一切。</font></font></p>
</blockquote>
<div class="markdown-heading" dir="auto"><h2 tabindex="-1" class="heading-element" dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">团队</font></font></h2><a id="user-content-the-team" class="anchor" aria-label="永久链接： 团队" href="#the-team"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a></div>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">非常感谢优秀的团队，没有他们，整个项目就不可能完成。</font><font style="vertical-align: inherit;">查看我们的个人资料并为我们的存储库加注星标！</font><font style="vertical-align: inherit;">:)</font></font></p>
<table>
<thead>
<tr>
<th><a target="_blank" rel="noopener noreferrer" href="/msaad1999/KLiK-SocialMediaWebsite/blob/master/_git%20assets/me.png"><img src="/msaad1999/KLiK-SocialMediaWebsite/raw/master/_git%20assets/me.png" width="150" style="max-width: 100%;"></a></th>
<th><a target="_blank" rel="noopener noreferrer" href="/msaad1999/KLiK-SocialMediaWebsite/blob/master/_git%20assets/kamal.png"><img src="/msaad1999/KLiK-SocialMediaWebsite/raw/master/_git%20assets/kamal.png" width="150" style="max-width: 100%;"></a></th>
<th><a target="_blank" rel="noopener noreferrer" href="/msaad1999/KLiK-SocialMediaWebsite/blob/master/_git%20assets/ubaid.png"><img src="/msaad1999/KLiK-SocialMediaWebsite/raw/master/_git%20assets/ubaid.png" width="150" style="max-width: 100%;"></a></th>
<th><a target="_blank" rel="noopener noreferrer" href="/msaad1999/KLiK-SocialMediaWebsite/blob/master/_git%20assets/ait.png"><img src="/msaad1999/KLiK-SocialMediaWebsite/raw/master/_git%20assets/ait.png" width="150" style="max-width: 100%;"></a></th>
</tr>
</thead>
<tbody>
<tr>
<td><a href="https://github.com/msaad1999"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">1999年MSAAD</font></font></a></td>
<td><a href="https://github.com/skamal16"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">斯卡马尔16</font></font></a></td>
<td><a href="https://github.com/aitasadduq"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">乌贝德·阿西姆</font></font></a></td>
<td><a href="https://github.com/aitasadduq"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">艾塔萨杜克</font></font></a></td>
</tr>
</tbody>
</table>
</article></div>
